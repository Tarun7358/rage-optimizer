...
export default function Home() {
  const { user, login, mockLogin, backendUrl, theme } = useAuth();
  ...
  return (
    <div className="min-h-screen pt-16 bg-darkBg text-textGray relative overflow-hidden transition-colors duration-300">
      {/* Background blobs */}
      <div className="absolute top-0 left-1/4 w-[500px] h-[500px] bg-accentRed/5 rounded-full blur-[160px] animate-pulse-glow pointer-events-none" />
      <div className="absolute bottom-1/3 right-1/4 w-[400px] h-[400px] bg-accentRed/3 rounded-full blur-[140px] animate-pulse-glow pointer-events-none" style={{ animationDelay: '2s' }} />

      {/* ── HERO ── */}
      <section className="container mx-auto px-6 pt-16 sm:pt-20 pb-12 text-center relative z-10">
        <motion.div
        ...
        <motion.h1
          ...
          className="text-4xl sm:text-6xl md:text-7xl lg:text-8xl font-gaming font-black tracking-tight leading-none mb-6 text-white"
        >
          DOMINATE YOUR<br />
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-accentRed via-violet-500 to-accentRed neon-text-glow">
            DISCORD SERVER
          </span>
        </motion.h1>
        ...
        <motion.p
          ...
          className="text-textGray max-w-2xl mx-auto text-sm sm:text-base md:text-lg mb-10 leading-relaxed"
        >
        ...
        <motion.div
          ...
          className="flex flex-col sm:flex-row justify-center items-center gap-4 max-w-lg mx-auto sm:max-w-none px-4"
        >
          <button
            onClick={handleCTA}
          ...
          <a
            ...
            className="w-full sm:w-auto bg-white/5 hover:bg-white/10 text-white border border-borderColor px-8 py-4 rounded-xl font-gaming font-black tracking-wider flex items-center justify-center space-x-3 transition-all hover:border-accentRed/40"
          >
          ...
          <button
            ...
            className="w-full sm:w-auto bg-white/5 hover:bg-white/10 text-textGray hover:text-white border border-borderColor px-6 py-4 rounded-xl font-gaming font-bold tracking-wider flex items-center justify-center space-x-2 transition-all text-sm"
          >
            <Play className="w-4 h-4 text-accentRed" />
            <span>DEV DEMO</span>
          </button>
        </motion.div>
      </section>
              ...
              >
                ...
                <AnimatePresence mode="wait">
                  <motion.span
                    ...
                    className={`block text-xl sm:text-2xl font-gaming font-black tracking-wider mb-1 ${card.color}`}
                  >
                    {card.value}
                  </motion.span>
                </AnimatePresence>
                <span className="text-textGray text-[9px] sm:text-[10px] font-semibold uppercase tracking-widest">{card.label}</span>
              </motion.div>
            );
          })}
        </div>
      ...
      {/* ── FEATURE GRID ── */}
      <section className="container mx-auto px-6 py-20 relative z-10 border-t border-borderColor">
        <div className="text-center mb-16">
          ...
          <p className="text-textGray text-xs sm:text-sm max-w-md mx-auto mt-3">
            ...
            return (
              ...
              >
                <div className="absolute top-4 right-4">
                  <span className="text-[9px] font-bold bg-accentRed/15 text-accentRed border border-accentRed/25 px-2.5 py-0.5 rounded-full uppercase tracking-wider">
                    {feat.badge}
                  </span>
                </div>
                <div className="w-12 h-12 sm:w-14 sm:h-14 bg-accentRed/10 border border-accentRed/20 text-accentRed rounded-xl flex items-center justify-center mb-6 group-hover:shadow-neonGlow transition-all">
                  <Icon className="w-6 h-6 sm:w-7 sm:h-7" />
                </div>
                <h3 className="text-lg sm:text-xl font-gaming font-bold text-white mb-3">{feat.title}</h3>
                <p className="text-textGray text-xs sm:text-sm leading-relaxed">{feat.desc}</p>
              </motion.div>
            );
          })}
        </div>
      ...
      <section className="container mx-auto px-6 py-20 relative z-10 border-t border-borderColor">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
          ...
          >
            ...
            <p className="text-textGray text-xs sm:text-sm mb-8 leading-relaxed">
              We leverage Discord v10 slash interface to compile robust interactive embeds, multiple-choice polls, and automated warning logs.
            </p>
                ...
                <button
                  ...
                  className={`px-4 py-2 text-xs font-gaming font-black uppercase tracking-wider rounded-lg border transition-all ${
                    activeTab === tab
                      ...
                      : 'bg-white/5 border-borderColor text-textGray hover:text-white hover:border-accentRed/40'
                  }`}
                >
                  {tab}
                </button>
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true }}
            className="bg-cardBgSolid border border-borderColor p-6 rounded-2xl space-y-3 shadow-2xl"
          >
            <div className="flex items-center space-x-2 mb-4 pb-3 border-b border-borderColor">
            ...
            <AnimatePresence mode="wait">
              ...
              >
                {commands[activeTab].map((cmd, i) => (
                  <div key={i} className="p-4 rounded-xl bg-white/3 border border-borderColor flex items-start space-x-4 hover:border-accentRed/25 transition-all">
                    <Terminal className={`w-4 h-4 ${cmd.color} mt-0.5 shrink-0`} />
                    <div>
                      <div className="text-xs sm:text-sm font-bold font-mono text-white mb-1">{cmd.name}</div>
                      <div className="text-[11px] sm:text-xs text-textGray leading-relaxed">{cmd.desc}</div>
                    </div>
                  </div>
                ))}
              </motion.div>
      ...
      <section className="container mx-auto px-6 py-16 relative z-10">
        <motion.div
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="relative overflow-hidden glass-card rounded-3xl p-8 sm:p-12 text-center border-accentRed/15"
        >
          ...
          <div className="relative z-10">
            ...
            <p className="text-textGray mb-8 max-w-md mx-auto text-xs sm:text-sm leading-relaxed">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <button
                onClick={handleCTA}
                className="bg-white/5 hover:bg-white/10 text-white border border-borderColor px-8 py-4 rounded-xl font-gaming font-black tracking-wider flex items-center justify-center space-x-3 transition-all hover:border-accentRed/40"
              >
      ...
      {/* ── FOOTER ── */}
      <footer className="border-t border-borderColor bg-cardBgSolid/95 py-10 relative z-10">
        <div className="container mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center space-x-3">
            <div className="w-8 h-8 rounded-lg overflow-hidden border border-borderColor shadow-neonGlow">
